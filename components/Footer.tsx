...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    Services: [
      ...
      { label: 'Implementation', href: '#what-we-do' },
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            >
              ...
              <p className="text-white/60 leading-relaxed max-w-md">
                The AI agency of the future. We build autonomous AI systems that 
                execute complex business operations and transform how enterprises work.
              </p>
            </motion.div>
